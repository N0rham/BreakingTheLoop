...
namespace NWH.VehiclePhysics2.Input
{
    ...
    public partial class InputSystemVehicleInputProvider : VehicleInputProviderBase
    {
        ...
        private static InputSystemVehicleInputProvider _actionsOwner;
        ...
        public new void Awake()
        {
            ...
            // If another provider already created actions, release them before replacing the static reference.
        ...
        {
            if (vehicleInputActions.VehicleControls.LowBeamLights.triggered)
                return true;
            ...
            return changer != null && changer.location == VehicleChanger.CharacterLocation.Inside;
        }
        ...
        public override void OnDestroy()
        {
            ...
            if (_actionsOwner == this && vehicleInputActions != null)
            {
                vehicleInputActions.Disable();
                vehicleInputActions.Dispose();
                vehicleInputActions = null;
                _actionsOwner = null;
            }
